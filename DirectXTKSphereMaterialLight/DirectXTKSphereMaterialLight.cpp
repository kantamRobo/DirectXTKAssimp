...
HRESULT DirectXTKSphereMaterialLight::CreateBuffers(DX::DeviceResources* DR, int width, int height)
{
...
DirectXTKSphereMaterialLight::DirectXTKSphereMaterialLight(UINT width, UINT height, std::wstring name)
{
}

// Update frame-based values.
void DirectXTKSphereMaterialLight::OnUpdate(DX::DeviceResources* DR)
{
...
void DirectXTKSphereMaterialLight::Draw(const DX::DeviceResources* DR) {
...
HRESULT DirectXTKSphereMaterialLight::CreateShaders(const DX::DeviceResources* deviceResources)
{
    //パイプラインステートの作成
